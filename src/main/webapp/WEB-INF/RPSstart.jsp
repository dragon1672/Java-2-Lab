...
<form action="${pageContext.request.contextPath}/RPS" method="GET">
  <input type="text" name="choice" style="display: none" value ="rock"/>
  <input class="button" type="submit" value="Rock"/>
</form>
<form action="${pageContext.request.contextPath}/RPS" method="GET">
  <input type="text" name="choice" style="display: none" value ="paper"/>
  <input class="button" type="submit" value="Paper"/>
</form>
<form action="${pageContext.request.contextPath}/RPS" method="GET">
  <input type="text" name="choice" style="display: none" value ="scissors"/>
